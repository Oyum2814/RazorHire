...
const formatBullets = (sentence) => {
  ...
  const items = sentence.split("|").map((item, index) => (
    <View
      key={index}
      style={{ flexDirection: "row", marginBottom: 4, marginLeft: -12 }}
    >
        ...
        <View style={styles.section}>
          <View style={{ display: "flex", flexDirection: "row" }}>
            <Text style={{ ...styles.header, width: "100%" }}>
              {info?.firstName ? info.firstName : "John"} {info?.middleName}{" "}
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <View
            style={{ display: "flex", flexDirection: "row", marginTop: "54px" }}
          >
            <View style={{ width: "40%" }}>
              <View style={{ marginBottom: "16px" }}>
                ...
                <View style={{ marginBottom: "2px" }}>
                  <Text style={styles.subHeader}>
                    {info?.site ? info.site : "www.site.com"}
                  </Text>
                </View>
              </View>
              ...
              <View style={{ marginBottom: "16px" }}>
                ...
                {!educations && (
                  <View style={{ marginBottom: "8px" }}>
                    <View>
                      <Text style={styles.subHeader}>Higher Secondary</Text>
                    </View>
                    <View>
                      <Text style={styles.subHeader}> DPS , Noida</Text>
                    </View>
                    <View style={{ marginTop: "4px" }}>
                      <Text style={styles.text}>Year of Passing - 2025</Text>
                    </View>
                ...
                {educations?.map((education, i) => (
                  <View key={i} style={{ marginBottom: "8px" }}>
                    <View>
                      <Text style={styles.subHeader}>{education?.degree}</Text>
                    </View>
                    <View>
                      <Text style={styles.subHeader}>
              ...
              <View style={{ marginBottom: "16px" }}>
                ...
                {socials?.map((social, i) => (
                  ...
                  >
                    ...
                    <Text style={styles.text}>
                      <Link src={social?.link} style={{ color: "black" }}>
                        {social?.username}
                      </Link>
                    </Text>
                  </View>
              ...
              <View style={{ marginBottom: "16px" }}>
                ...
                {projects?.map((project, i) => (
                  <View key={i} style={{ marginBottom: "8px" }}>
                    <View>
                      <Text style={styles.subHeader}>
                        <Link src={project?.link} style={{ color: "black" }}>
                          {project?.title}
                        </Link>
                      </Text>
                    </View>
            ...
            >
              ...
              <View style={{ flexDirection: "column", fontSize: "16px" }}>
                <View style={{ marginBottom: "4px" }}>
                  <Text>{info?.phone ? info.phone : "+91 1234567890"}</Text>
                </View>
                <View>
                  <Text>
                    {info?.address ? info.address : "Suite 444-A Padberg"}
        ...
        <View style={styles.section}>
          ...
          >
            <View style={{ width: "40%" }}>
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>Academic</Text>
                </View>
              ...
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>Skills</Text>
                </View>
                {skills?.map((title, i) => (
                  <Text style={styles.text} key={i}>
                    {title}
              ...
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>Socials</Text>
                </View>
                {socials?.map((social, i) => (
                  <View
                    key={i}
            ...
            <View style={{ width: "50%" }}>
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>My Story</Text>
                </View>
                <Text style={styles.text}>{info?.summary}</Text>
              </View>
              ...
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>Internship</Text>
                </View>
                {experiences?.map((experience, i) => (
                  <View key={i} style={{ marginBottom: "8px" }}>
                    <View>
              ...
              <View style={{ marginBottom: "16px" }}>
                <View>
                  <Text style={styles4.header}>projects</Text>
                </View>
                {projects?.map((project, i) => (
                  <View key={i} style={{ marginBottom: "8px" }}>
                    <View>
