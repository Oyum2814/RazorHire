...
const Resume = ({ resumeName }) => {
  ...
  return (
    <>
      <div
        className="md:h-screen w-screen flex flex-col-reverse  justify-between absolute md:overflow-y-hidden
            md:flex-row"
      >
        <section
          id="about-sc"
              ...
              <form action="" className="cv-form" id="cv-form">
                <div className="cv-form-blk">
                  <div className="cv-form-row-title">
                    <h2 className="font-[600] uppercase tracking-[1.5px] text-xl">
                      About section
                    </h2>
                  </div>
                      ...
                      {educations?.map((education, index) => (
                        <div data-repeater-item key={index}>
                          <div className="cv-form-row cv-form-row-experience">
                            ...
                            <p className="text-xs p-4 font-bold text-neutral-500">
                          ...
                          <div className="form-elem">
                            ...
                            <div className="flex flex-col">
                              ...
                              <button
                                ...
                                data-repeater-create
                                value="Add"
                                className=" bg-blue-600 text-white font-bold px-4 py-2 text-sm mt-2 rounded-md mx-auto"
                                onClick={() => {
                            ...
                            <div className="px-2 pt-2 pb-11 mb-3 flex flex-wrap rounded-lg  bg-gray-400 mt-2">
                              {skills?.map((skill, index) => (
                                <div key={index}>
                                  <span className="flex flex-wrap pl-4 pr-2 py-2 m-1 justify-between items-center text-sm font-medium rounded-xl cursor-pointer  bg-gray-700 text-gray-200 hover:bg-gray-800 hover:text-gray-100">
                                    {skill}
                                    <svg
                                      onClick={(e) => {
                                        setSkills((prevSkills) =>
        ...
        <div className="hidden md:block h-full w-[1px] bg-neutral-300"></div>
